...
<body class="">
    <div class="wrapper ">
        <div class="sidebar" data-color="orange">
            ...
            <div class="logo">
                <a href="http://www.sms.com" class="simple-text logo-mini">
                    SMS
                </a>
                <a style="font-family:palatino ;color:indigo href=" http://www.sms.com"
            ...
            <div class="main-panel" id="main-panel">
                ...
                <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                    <div class="container-fluid">
                        ...
                        {{--Seraching teacher for DELETING IN TEACHER LIST--}}
                        <div class="collapse navbar-collapse justify-content-end" id="navigation">
                            <form method="POST" action="{{route('searchh')}}">
                                {{--<form>--}}
                                @csrf
    ...
    {{--Edit and Delte using Modal For teacher--}}
    <script>
        $('#tedit').on('show.bs.modal', function (event) {
    ...
    <script>
        $('#tdelete').on('show.bs.modal', function (event) {
            console.log("modal opened")
            var button = $(event.relatedTarget)
