...
<body class="">
    ...
    -->
            <div class="logo">
                ...
                <a  style="font-family:palatino ;color:indigo href="http://www.creative-tim.com" class="simple-text logo-normal">
        ...
        <div class="main-panel" id="main-panel">
                ...
                <div class="container-fluid">
                    ...
                    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navigation"
                      ...
                      <div class="collapse navbar-collapse justify-content-end" id="navigation">
                       <form method="POST" action="{{route('searchhh')}}">
                        {{--<form>--}}
                        @csrf
            ...
            <script>
                $('#oedit').on('show.bs.modal', function (event) {
             ...
             <script>
                $('#odelete').on('show.bs.modal', function (event) {
                    console.log("modal opened")
                    var button = $(event.relatedTarget)
