...
<body class="hold-transition sidebar-mini">
    <div class="wrapper" id="app" data-toggle="toggle">
        ...
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand navbar-white navbar-green">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <a href="{{route('shome')}}" class="nav-link">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                           <a href="{{route('borrowedmat.create')}}" class="nav-link">
    ...
    {{--Edit and Delte using Modal For Material--}}
    <script>
        $('#bedit').on('show.bs.modal', function (event) {
            console.log("modal opened")
           
            var button = $(event.relatedTarget)
            var fullname = button.data('bfullname')
            var adress = button.data('badress')
           var bphonenumber = button.data('bphonenumber')
            var boccupation = button.data('boccupation')
            var materialsname = button.data('materialsname')
            var materialsserialnumber = button.data('materialsserialnumber')
            var quantity = button.data('quantity')
            var condition = button.data('condition')
           var storenumber = button.data('storenumber')
            var shelfnumber = button.data('shelfnumber')
            ...
            modal.find('.modal-body #bfullname').val(fullname)
            modal.find('.modal-body #badress').val(adress)
             modal.find('.modal-body #bphonenumber').val(bphonenumber)
            modal.find('.modal-body #boccupation').val(boccupation)
            modal.find('.modal-body #materialsname').val(materialsname)
            modal.find('.modal-body #materialsserialnumber').val(materialsserialnumber)
            modal.find('.modal-body #quantity').val(quantity)
            modal.find('.modal-body #condition').val(condition)
            modal.find('.modal-body #storenumber').val(storenumber)
            modal.find('.modal-body #shelfnumber').val(shelfnumber)
    ...
    <script>
        $('#bdelete').on('show.bs.modal', function (event) {
            console.log("modal opened")
            var button = $(event.relatedTarget)
