...
<body class="hold-transition sidebar-mini">
    <div class="wrapper" id="app" data-toggle="toggle">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-success">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                <a class="nav-link" data-widget="pushmenu" href="{{route('shome')}}"><i class="fas fa-bars"></i></a>
                </li>
            ...
            <!-- SEARCH FORM -->
        <form class="form-inline ml-3" method='Post'  action="{{route('msearch')}}">
            @csrf
                <div class="input-group input-group-sm">
                    <input class="form-control form-control-navbar" type="search" placeholder="Search" name="show" aria-label="Search">
